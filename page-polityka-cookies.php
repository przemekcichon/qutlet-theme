<?php
/**
 * Qutlet — Polityka cookies (P-8.5, port design/vanilla/polityka-cookies.html).
 *
 * Klasyczny szablon dobrany przez hierarchię plików WP wg slugu Strony
 * (`page-polityka-cookies.php`) — patrz `page-regulamin.php` po pełne
 * uzasadnienie wzorca. Treść Strony zawiera dodatkowo tabele trackerów
 * (`.ck-table`) — te same style co w prototypie, wklejone verbatim w
 * `the_content()` (nie ma tu żadnej logiki poza regulaminowym wzorcem).
 *
...
<main class="wrap">
	<nav class="breadcrumbs">
		...
		<span class="current"><?php esc_html_e( 'Polityka cookies', 'qutlet-theme' ); ?></span>
	</nav>
